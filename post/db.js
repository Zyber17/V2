...
(function() {
  var ObjectId, Schema, articleBodies, bcrypt, database, issues, mongoose, monguurl, photos, saltWorkFactor, sections, stories, users;
  ...
  module.exports = {
    ObjectId: ObjectId,
    Stories: database.model('stories', stories),
