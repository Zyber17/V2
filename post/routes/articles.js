        ...
        if (recent.length) {
          ...
          for (i = _i = 0, _len = recent.length; _i < _len; i = ++_i) {
            ...
            recentAr[i] = {
              ...
              photo: article.photos[0] ? photo_bucket_url + article._id + '/' + (article.photos[0].length > 1 ? article.photos[article.photos.length - 2].name : article.photos[article.photos.length - 1].name) : void 0,
