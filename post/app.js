...
(function() {
  var RedisStore, app, articles, auth, cluster, cpu, cpus, express, http, issues, moment, path, photos, rss, search, sections, setup, staff, users, _i;
  ...
  if (cluster.isMaster) {
    ...
    app.configure(function() {
      ...
      app.use(express.session({
        ...
        secret: '0OXl1mrfghjnmkSRMnR1WS40p58R'
      }));
      moment.lang('en', {
