...
if cluster.isMaster
	...
	app.get '/issues/current', (req,res,next) ->
		res.redirect 'https://s3.amazonaws.com/torch_issues/may_2014.pdf' #Old issue selectioncold, not needed for now: + (if moment() < moment("2014-5-23") then 'april_2014' else 'may_2014')
